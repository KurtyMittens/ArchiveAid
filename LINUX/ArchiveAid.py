...
class FileButton(QtWidgets.QFrame):
    ...
    def __init__(self, filename, frame, recent_class):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ArchiveAid/assets/file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("ArchiveAid/assets/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("ArchiveAid/assets/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
class ArchiveAid(QtWidgets.QMainWindow):
    ...
    def setup(self, main):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ArchiveAid/assets/logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menu_button.setStyleSheet("QPushButton{\n"
                                       ...
                                       "}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ArchiveAid/assets/menu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.logo = QtGui.QPixmap("ArchiveAid/assets/logo.png")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("ArchiveAid/assets/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("ArchiveAid/assets/reset.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("ArchiveAid/assets/back.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
